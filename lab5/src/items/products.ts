...
export interface Product {
  ...
  export const products: Product[] = [
    ...
    },
    {
      ...
      name: "Kieslect K11",
      price: 24980,
      description: "Умные Watches Kieslect K11 оснащены постоянно включенным полноэкранным сенсорным дисплеем с разрешением 1.39 Ultra Amoled.",
      rating: 5,
    ...
    },
    {
      ...
      price: 2000,
      description: "Книга Нұршайықов Ә.: Махаббат, қызық мол жылдар",
      rating: 5,
      url: "https://kaspi.kz/shop/p/amazon-kindle-paperwhite-2021-chernyi-102838488/?c=750000000#!/item",
      imgURL: "https://resources.cdn-kaspi.kz/shop/medias/sys_master/images/images/h53/h4a/34008890048542/n-rsajyk-ov-mahabbat-k-yzyk-mol-zyldar-101072467-1-Container.jpg",
